...
class PickleConsolidate4Test(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertNotEqual(web_site.pages[0].uri.host, web_site_version.pages[0].uri.host)
        self.assertEqual(web_site.pages[0].uri.path, web_site_version.pages[0].uri.path)
