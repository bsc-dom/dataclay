...
class MoveSameTest(unittest.TestCase):
    ...
    def test(self):
        ...
        # Move in the same location
        getRuntime().move_object(web_site, environment1_id, environment1_id, True)
        ...
        # Check that the object and associated ones are still in the same location
        self.assertEqual(len(ws_locations), 1) 
        self.assertIn(environment1_id, ws_locations)
