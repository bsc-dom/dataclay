...
"""
RecursiveMoveObjects testing. 
"""
logger = logging.getLogger(__name__)


class RecursiveMoveObjectsTest(unittest.TestCase):
    ...
    def test(self):
        ...
        getRuntime().move_object(web_site, environment1_id, environment2_id, True)
        ...
        # Check that the object and associated ones are now in the other location
        self.assertEqual(len(ws_locations), 1) 
