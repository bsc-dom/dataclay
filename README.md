...
[![Build status](https://ci.appveyor.com/api/projects/status/dwam0x48dc59p3jq/branch/master?svg=true&passingText=Passing+functional+tests&pendingText=Building+functional+tests)](https://dataclay.bsc.es/testing-report/)
