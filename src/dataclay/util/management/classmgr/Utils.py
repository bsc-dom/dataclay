...
docstring_types = dict(starmap(lambda what, type_c: (what[0], type_c), mapping_table))

instance_types = dict(starmap(lambda what, type_c: (what[1], type_c), mapping_table))

serialization_types = dict(starmap(lambda what, type_c: (type_c.signature, what[2]), mapping_table))
