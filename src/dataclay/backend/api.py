...
class BackendAPI:
    ...
    async def get_object_attribute(self, object_id: UUID, attribute: str) -> bytes:
    ...
    async def set_object_attribute(
        ...
        # TODO: Check if is needed dcloads (Marc: i think yes since we could set dc objects)
